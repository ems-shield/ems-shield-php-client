...
class IpStatus 
{
	...
	/**
	 * Show ip status ip status versions list
	 * 
	 * Excepted HTTP code : 200
	 * 
	 ...
	 * @throws UnexpectedResponseException
	 */
	public function getVersions($search = null, $page = null, $limit = null)
	{
		$routePath = '/api/ipStatus/{ipStatusId}/version';
	 ...
	 * @throws UnexpectedResponseException
	 */
	public function getIps($search = null, $page = null, $limit = null)
	{
		$routePath = '/api/ipStatus/{ipStatusId}/ip';
	...
	{
		$routePath = '/api/ipStatus/{ipStatusId}/ipLog';
